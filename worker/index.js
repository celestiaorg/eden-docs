 ...
 * the MCP endpoint at /mcp and passes every other request through to the
 * static site. Tools mirror vocs's built-in MCP server (list_pages /
 * read_page / search_docs), but read the markdown the vocs build emits as
 * static assets — llms.txt for the page index and /assets/md/<path>.md for
 * page content — instead of the filesystem.
 *
