...
The demo uses RedStone price-feed events as a concrete data source. You can reuse the same pattern
for other Eden contracts by changing the ABI, address, and GraphQL queries.
