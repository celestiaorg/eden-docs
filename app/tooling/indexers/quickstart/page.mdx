...
Using the GraphQL endpoint ([example](https://api.goldsky.com/api/public/project_cmf4aw4t78kut01ya4vbh4iz6/subgraphs/redstone-testnet-fast-eden-testnet/1.0.0/gn)), you can query the subgraph for data. For example, to get the latest value updates from the RedStone adapter:
...
<html>
  ...
  <body>
    ...
    <script>
      ...
      const SUBGRAPH_URL =
        'https://api.goldsky.com/api/public/project_cmf4aw4t78kut01ya4vbh4iz6/subgraphs/redstone-testnet-fast-eden-testnet/1.0.0/gn'
