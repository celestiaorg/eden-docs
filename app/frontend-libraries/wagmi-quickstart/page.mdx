...
This quickstart will guide you through the process of setting up a frontend application using [wagmi](https://wagmi.sh/), a popular React library for interacting with EVM networks and connecting your MetaMask wallet to Eden Testnet.
