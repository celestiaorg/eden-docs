...
[rpc_endpoints]
eden = "https://ev-reth-eden-testnet.binarybuilders.services:8545/"
```

<Callout type="info">
  Use an RPC endpoint from the [RPCs list](/networks/testnet#rpcs). Some endpoints may be
  temporarily unavailable, if one fails, try another from the list.
</Callout>
...
<Callout type="info">
  The chain ID 3735928814 is for Eden testnet. For mainnet, use chain ID 42420. See the [RPCs
  page](/networks/rpcs) for current values.
</Callout>
...
Check addresses and transactions at [https://explorer-eden-testnet.binarybuilders.services](https://explorer-eden-testnet.binarybuilders.services)
...
forge verify-contract \
    ...
    --verifier blockscout \
    --verifier-url 'https://explorer-eden-testnet.binarybuilders.services:443/api/' \
