...
[rpc_endpoints]
eden = "https://rpc.testnet.eden.gateway.fm/"
```
...
<Callout type="info">
  The chain ID 3735928814 is for Eden testnet. For mainnet, use chain ID TODO: TBD. See the [RPCs
...
forge verify-contract \
    --rpc-url https://rpc.testnet.eden.gateway.fm/ \
    --verifier blockscout \
...
curl -s https://rpc.testnet.eden.gateway.fm/ -X POST -H "Content-Type: application/json" -d '{"jsonrpc":"2.0","method":"eth_blockNumber","params":[],"id":1}'
```
