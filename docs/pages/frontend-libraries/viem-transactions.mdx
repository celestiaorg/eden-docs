...
- [Send a sponsored transaction](https://eden-testnet.blockscout.com/tx/0x4776ece6dcfdaf35f7bc46e79ab3321055c73f761d8232afaa62565829f48721):
  Eden type `0x76`, with an unfunded executor as `from` and the sponsor as `feePayer`.
