...
:::info
Eden testnet Blockscout transaction links may not display type `0x76` transactions by hash yet.
Verify sponsored transactions with `cast tx`, `cast receipt`, or direct RPC calls until explorer
indexing supports this transaction type.
:::
