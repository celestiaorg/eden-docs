...
A minimal guide to deploying and interacting with smart contracts on **Celestia Eden** using [Foundry](https://www.getfoundry.sh/).

## Prerequisites

- [Foundry](https://www.getfoundry.sh/introduction/installation) installed (`foundryup`)
