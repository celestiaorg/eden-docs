...
Frontends connect users to onchain applications. They can be built with any framework, but often use a library like [Viem](/frontend-libraries/viem-quickstart) to interact with the chain.
